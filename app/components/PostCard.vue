<template>
  <div
    class="bg-white rounded shadow-sm p-1 w-full sm:min-w-[600px] border border-gray-100"
  >
    <div class="relative h-72 group">
      ...
      <div
        v-else
        class="absolute inset-0 bg-gray-200 flex items-center justify-center text-gray-500 rounded"
      >
        No image
      </div>

      <div
        class="absolute inset-0 bg-gradient-to-b from-black/60 via-black/30 to-transparent rounded"
      ></div>
      ...
      <div class="absolute top-4 left-4 z-10 flex items-center gap-3">
        ...
        <div class="text-white">
          <div class="font-semibold leading-tight flex items-center gap-1">
  {{ post.user?.username }}
  <i
    v-if="post.user?.is_verified"
    class="bx bxs-badge-check text-[#10b481] text-lg"
    ...
    <div class="p-6 space-y-2">
      ...
      <div class="flex items-center justify-between gap-4 w-full pt-6">
        ...
        <button
          ...
          @click="openModal"
          :class="[
            'flex items-center text-sm gap-2 px-5 py-2 rounded font-semibold text-white shadow-lg transition-all duration-300 transform hover:scale-105 hover:-translate-y-[1px] hover:shadow-xl focus:outline-none focus:ring-4',
            post.type_post?.type === 'Selling'
              ? 'bg-[#10b481] focus:ring-green-200'
              : 'bg-[#f4a261] focus:ring-orange-200',
          ]"
        >
          <i
            :class="
            ...
            <div class="md:w-1/2 flex flex-col justify-between gap-4">
              ...
              <div class="mt-4 flex flex-col gap-3 text-sm">
                ...
                <button
                  ...
                  @click="sendBid"
                  :class="[
                    'flex items-center justify-center gap-2 w-full text-white font-semibold py-3 rounded shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-green-200',
                    post.type_post?.type === 'Selling'
                      ? 'bg-[#10b481]'
                      : 'bg-[#f4a261]',
